...
<body>
    ...
    if(!(mysqli_num_rows($result)>0)){  // if the number of rows is not greater then 0 or empty
        echo"NO task found.";
    ...
    <a href="task.php">click to go back...</a>
</body>
</html>
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    $statuses=array();
    foreach($_POST["statuses"] as $status){ // assign done and ofcourse there goinng to all be ordered by project id.
        $statuses[]=$status;
    }
